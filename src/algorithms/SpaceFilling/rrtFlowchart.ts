...
extend["Model (simulate) the motion of the agent<br/>extending from the 'nearest node'<br/>towards the chosen 'configuration'<br/>until a collision,<br/>or the 'maximum distance' is reached.<br/>Place a 'new node' here."];
